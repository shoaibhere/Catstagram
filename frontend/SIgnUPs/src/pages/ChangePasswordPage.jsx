...
const ChangePasswordPage = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-md w-full bg-gradient-to-r from-purple-700 to-indigo-900 text-white rounded-2xl shadow-xl overflow-hidden"
    >
      <div className="p-8 relative">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full py-3 px-4 bg-gradient-to-r from-purple-600 to-indigo-700 text-white font-bold rounded-lg shadow-lg hover:from-purple-700 hover:to-indigo-800 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition duration-200"
            type="submit"
            disabled={isLoading}
          >
