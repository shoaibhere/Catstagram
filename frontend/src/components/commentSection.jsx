...
const CommentSection = ({ postId, userId, onCommentCountChange }) => {
  ...
  const fetchComments = async () => {
    try {
      const response = await fetch(`https://catstagram-production.up.railway.app/api/comment/${postId}`);
  ...
  const handleAddComment = async () => {
    try {
      const response = await fetch(`https://catstagram-production.up.railway.app/api/comment/add-comment/${postId}/${userId}`, {
        method: 'POST',
        headers: {
  ...
  const handleEditComment = async () => {
    try {
      const response = await fetch(`https://catstagram-production.up.railway.app/api/comment/edit-comment/${editingCommentId}/${userId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleRemoveComment = async (commentId) => {
    try {
      const response = await fetch(`https://catstagram-production.up.railway.app/api/comment/remove-comment/${commentId}/${userId}`, {
        method: 'GET',
      });
  ...
  const startEditing = async (commentId) => {
    try {
      const response = await fetch(`https://catstagram-production.up.railway.app/api/comment/get-one/${commentId}`);
