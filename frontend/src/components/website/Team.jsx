...
const Team = () => {
  ...
  return (
    <section id="team" className="pt-8 border-t border-purple-900 dark:border-purple-900 py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800 dark:text-gray-200">Our Catstagram Team</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          {teamMembers.map((member, index) => (
            <div key={index} className="text-center group">
              ...
              <p className="text-purple-600 dark:text-purple-300 font-medium">{member.role}</p>
            </div>
          ))}
        </div>
      </div>
